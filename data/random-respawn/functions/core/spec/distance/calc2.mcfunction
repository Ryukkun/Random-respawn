...
# 入力に応じてスケール変更
scoreboard players operation V AiMath = @s F-Distance
execute if score V AiMath matches ..999999 run scoreboard players operation V AiMath *= $100 F-Temp
execute if score V AiMath matches ..999999 run scoreboard players operation V AiMath *= $100 F-Temp
execute if score V AiMath matches ..999999 run scoreboard players operation V AiMath *= $100 F-Temp
execute if score V AiMath matches ..999999 run scoreboard players operation V AiMath *= $100 F-Temp
execute if score V AiMath matches ..999999 run scoreboard players operation V AiMath *= $100 F-Temp
...
execute store result score @s F-Distance run data get storage math: out 
