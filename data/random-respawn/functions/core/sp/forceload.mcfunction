...
execute if score $First-SP F-Meet = $PlayerCount F-Meet if score $gm F-Temp matches 1..3 run function random-respawn:core/1-3/countdown/countdown-start
execute if score $First-SP F-Meet = $PlayerCount F-Meet if score $gm F-Temp matches 4 run function random-respawn:core/4/countdown/countdown-start
