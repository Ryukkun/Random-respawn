#   Load by random-respawn:core/countdown/count/1
#   カウントダウンが残り1秒になったときに実行される
#--------------------
...
#Test Marker
execute as @a[team=Player] at @s run summon armor_stand ~ ~ ~ {Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,ShowArms:1b,Marker:1b,Pose:{Body:[0f,4f,2f],LeftLeg:[0f,0f,342f],LeftArm:[0f,0f,219f],RightArm:[0f,0f,24f]},Tags:["First-SP","First-SP-M"]}
